...
<body class="page" data-note="notes-work">
    ...
    <?php else : ?>
        ...
        <main class="notes-work">
            <div class="content-wrap">
                <h2 class="title">
                    Заметки для сотрудников
                </h2>
                <div class="form-navigation-row">
                    <button class="add-note-btn notes-work__add-note-btn">
                        Добавить запись
                    </button>
                    <a class="archive-link" href="archive.php?page=note">Архив записей</a>
                    <div class="search">
            ...
            <div class="modal-overlay" id="notes-work__overlay">
                <div class="modal form__modal" id="notes-work__modal">
                    <a class="close-modal" id="notes-work__close">
                        <svg viewBox="0 0 20 20">
                            <path fill="#000000" d="M15.898,4.045c-0.271-0.272-0.713-0.272-0.986,0l-4.71,4.711L5.493,4.045c-0.272-0.272-0.714-0.272-0.986,0s-0.272,0.714,0,0.986l4.709,4.711l-4.71,4.711c-0.272,0.271-0.272,0.713,0,0.986c0.136,0.136,0.314,0.203,0.492,0.203c0.179,0,0.357-0.067,0.493-0.203l4.711-4.711l4.71,4.711c0.137,0.136,0.314,0.203,0.494,0.203c0.178,0,0.355-0.067,0.492-0.203c0.273-0.273,0.273-0.715,0-0.986l-4.711-4.711l4.711-4.711C16.172,4.759,16.172,4.317,15.898,4.045z">
                            </path>
                        </svg>
                    </a><!-- close modal notes-work -->

                    <div class="modal-content">
                        <form action="assets/php/notes/add_note.php?page=note" method="post" class="form notes-work__form">
