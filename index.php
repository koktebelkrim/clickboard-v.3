...
С уважением, компания Гарсинг!
          ...
          <input class="fieldset-template__input" type="text" name="" id="input__sdek" placeholder="Введите трек-номер"
            pattern="[0-9]{10}">
          <div class="fieldset-template__holder">
            <img class="fieldset__logo" src="assets/img/logo_sdek.png" alt="sdek">
            <button class="btn fieldset-template__btn" type="button" data-clipboard-action="copy"
              data-clipboard-target="#copy__sdek">Копировать</button>
          </div>
        </div>
        <div class="fieldset-template">
          <div class="hidden-box">
...
С уважением, компания Гарсинг!
          ...
          <input type="text" name="" id="input__mail" placeholder="Введите трек-номер" class="fieldset-template__input"
            pattern="[0-9]{14}">
          <div class="fieldset-template__holder">
            <img class="fieldset__logo" src="assets/img/logo_mail.png" alt="mail">
            <button type="button" class="btn fieldset-template__btn" data-clipboard-action="copy"
              data-clipboard-target="#copy__mail">Копировать</button>
          </div>
        </div>
        <button type="button" class="fieldset-template__btn fieldset-template__btn_long"
          id="outcall__btn">Недозвон</button> <!-- btn__outcall -->
      </div>
...
Если вы согласны с условиями заказа, просьба дать подтверждение в ответном письме. <div id="payOnline" style="display: inline;"></div> 
          ...
          <input type="text" name="order" id="outCall__orderInput" placeholder="Номер заказа"
            class="fieldset-template__input fieldset-template__input--modal" pattern="[0-9]{4}">

          <label for="count">Количество товара</label>
          <input type="number" class="fieldset-template__input fieldset-template__input--modal"
            id="outCall__countProductsSelect" placeholder="Количество позиций">
          ...
          <input type="text" name="orderAdress" id="outCall__deliveryAdressInput" placeholder="Адрес доставки"
            class="fieldset-template__input fieldset-template__input--modal">

          <label for="delivery">Стоймость доставки</label>
          <input type="text" name="delivery" id="outCall__deliveryPriceInput" placeholder="Стоймость доставки"
            class="fieldset-template__input fieldset-template__input--modal">

          <label for="totalAmount">Общая сумма</label>
          <input type="text" name="totalAmount" id="outCall__totalPriceInput" placeholder="Общая сумма заказа"
            class="fieldset-template__input fieldset-template__input--modal">
          ...
          <form action="index.php">
            <button type="submit" class="btn fieldset-template__btn outcall__btn" data-clipboard-action="copy"
              data-clipboard-target="#copy__outCall">Копировать
            </button>
          </form>
  ...
  <div class="modal-overlay" id="boots__overlay">
    <div class="modal" id="boots__modal">
