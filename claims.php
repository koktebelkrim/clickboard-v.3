...
<main class="claims">
    <div class="content-wrap">
        <h2 class="title">Претензии клиентов</h2>

        <div class="form-navigation-row">
            <button class="add-note-btn claims__add-note-btn">Добавить запись</button>
            <a class="archive-link" href="archive.php?page=claims">Архив записей</a>
            <div class="search">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    "
                        ...
                        <a href='assets/php/notes/delete_note.php?id=".$row["id"]."&page=claims'>
                            <button class='remove'><img src='https://image.flaticon.com/icons/png/512/3096/3096673.png'></button>
                        </a>

                        <form action='assets/php/notes/edit_note.php?id=".$row["id"]."&page=claims' method='post'>
    ...
    <div class="modal-overlay" id="claims__overlay">
        <div class="modal form__modal" id="claims__modal">
            <a class="close-modal" id="claims__close">
                <svg viewBox="0 0 20 20">
                    <path fill="#000000" d="M15.898,4.045c-0.271-0.272-0.713-0.272-0.986,0l-4.71,4.711L5.493,4.045c-0.272-0.272-0.714-0.272-0.986,0s-0.272,0.714,0,0.986l4.709,4.711l-4.71,4.711c-0.272,0.271-0.272,0.713,0,0.986c0.136,0.136,0.314,0.203,0.492,0.203c0.179,0,0.357-0.067,0.493-0.203l4.711-4.711l4.71,4.711c0.137,0.136,0.314,0.203,0.494,0.203c0.178,0,0.355-0.067,0.492-0.203c0.273-0.273,0.273-0.715,0-0.986l-4.711-4.711l4.711-4.711C16.172,4.759,16.172,4.317,15.898,4.045z">
                    </path>
                </svg>
            </a>
            <form class="modal-content" action="assets/php/notes/add_note.php?page=claims" method="post">
                <div class="form claims__form">
